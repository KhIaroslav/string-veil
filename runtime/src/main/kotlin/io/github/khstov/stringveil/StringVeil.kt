...
package io.github.khstov.stringveil
 ...
 * places a declaration-level `@Obfuscate` cannot reach:
 * `by lazy { }` delegates, `companion object` / static initializers, interpolation fragments, and
 * sub-expressions.
 *
