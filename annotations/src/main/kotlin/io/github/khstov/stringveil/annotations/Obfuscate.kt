package io.github.khstov.stringveil.annotations
 ...
 * and field bytecode shapes, including a directly annotated computed property's custom getter.
 * Compiler-generated lambdas and nested classes do not belong to the enclosing declaration's
 * bytecode scope; see the README's limitations and use the per-literal marker where appropriate.
 *
